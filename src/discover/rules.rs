...
pub const PATTERNS: &[&str] = &[
    ...
    r"^gh\s+(pr|issue|run|repo|api|release|auth|workflow|gist|codespace|label|secret|variable|cache|extension|ssh-key|gpg-key|status|browse|alias|config|completion)",
    r"^cargo\s+(build|test|clippy|check|fmt|install|tree|doc|bench|clean|update|publish|add|remove|run|init|new|fix|audit|deny|deb|generate-rpm)",
...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        ...
        subcmd_status: &[
            ...
            ("workflow", RtkStatus::Passthrough),
            ("gist", RtkStatus::Passthrough),
            ("codespace", RtkStatus::Passthrough),
            ("label", RtkStatus::Passthrough),
            ("secret", RtkStatus::Passthrough),
            ("variable", RtkStatus::Passthrough),
            ("cache", RtkStatus::Passthrough),
            ("extension", RtkStatus::Passthrough),
            ("ssh-key", RtkStatus::Passthrough),
            ("gpg-key", RtkStatus::Passthrough),
            ("status", RtkStatus::Passthrough),
            ("browse", RtkStatus::Passthrough),
            ("alias", RtkStatus::Passthrough),
            ("config", RtkStatus::Passthrough),
            ("completion", RtkStatus::Passthrough),
        ],
    },
    RtkRule {
        rtk_cmd: "rtk cargo",
        ...
        subcmd_status: &[
            ...
            ("fix", RtkStatus::Passthrough),
            ("audit", RtkStatus::Passthrough),
            ("deny", RtkStatus::Passthrough),
            ("deb", RtkStatus::Passthrough),
            ("generate-rpm", RtkStatus::Passthrough),
        ],
    },
    RtkRule {
        rtk_cmd: "rtk pnpm",
